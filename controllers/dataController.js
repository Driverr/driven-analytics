...
exports.getAccelerationY = function(req,res) {
    ...
    pool.getConnection(function(err,connection){
        ...
        connection.beginTransaction(function(err){
            ...
            var query = "select timestamp as date, ay_max as high, ay_min as low, ay_avg as open, ay_avg as close from trip_details where driver_id = 0 and trip_id = 1 group by timestamp";
